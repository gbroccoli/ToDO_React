// Перечисление для статусов регистрации
...
// Перечисление для статусов выхода из системы (logout)
enum LogoutStatus {
...
// Перечисление для статусов JWT (JSON Web Token)
enum JWTStatus {
